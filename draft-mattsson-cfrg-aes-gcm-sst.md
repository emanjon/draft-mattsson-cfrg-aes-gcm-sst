...
Inoue et al. {{Inoue}} and Naito et al. {{Naito}} establish the security of GCM-SST in the single- and multi-user settings, including under nonce randomization and nonce-based key derivation.
