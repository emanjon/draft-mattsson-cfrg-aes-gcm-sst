...
This section defines the Galois Counter Mode with Secure Short Tags (GCM-SST)  following the recommendations from Nyberg et al. {{Nyberg}}. GCM-SST is defined with a general interface so that it can be used with any keystream generator, not just a 128-bit block cipher.
...
{: #iana-algs title="s" cols="l r r r"}
