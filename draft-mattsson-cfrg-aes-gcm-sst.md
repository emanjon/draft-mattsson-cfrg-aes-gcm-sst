...
For a given key, the number of invocations q of the authenticated encryption function SHALL NOT exceed 2<sup>32</sup>. Similarly, for a given key, the number of invocations q' of the authenticated decryption function SHALL NOT exceed 2<sup>48</sup> for AES-GCM-SST, and 2<sup>88</sup> for Rijndael-GCM-SST. These constraints on q' ensure that the Bernstein bound factor δ remains approximately 1 for both Rijndael-GCM-SST at all times and for AES-GCM-SST in protocols where P_MAX = 2<sup>16</sup>.
