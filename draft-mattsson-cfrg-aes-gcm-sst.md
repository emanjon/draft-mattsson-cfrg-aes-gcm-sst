...
The Bernstein bound factor δ(a) ≈ 1 + a<sup>2</sup> / 2<sup>b+1</sup> depends on varaiable a {{Bernstein}}{{Iwata}}, which this document conservatively upper-bounds using Q_MAX ⋅ P_MAX / 16 + V_MAX, using the bounds in {{Naito}}.
